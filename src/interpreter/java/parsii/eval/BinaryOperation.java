 ...
 */
public class BinaryOperation extends StringBasedExpression {
    ...
    private final Op op;
    private StringBasedExpression left;
    private StringBasedExpression right;
     ...
     */
    public BinaryOperation(Op op, StringBasedExpression left, StringBasedExpression right) {
        this.op = op;
        this.left = left;
        this.right = right;
    }
     ...
     */
    public StringBasedExpression getLeft() {
        return left;
    }
     ...
     */
    public void setLeft(StringBasedExpression left) {
        this.left = left;
    }
     ...
     */
    public StringBasedExpression getRight() {
        return right;
    }
    ...
    public StringBasedExpression simplify() {
        ...
        if (op == Op.ADD || op == Op.MULTIPLY) {
            ...
            if (right.isConstant()) {
                StringBasedExpression tmp = right;
                right = left;
                left = tmp;
            }
