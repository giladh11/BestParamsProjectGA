...
import interpreter.java.parsii.tokenizer.ParseError;
import interpreter.java.parsii.tokenizer.ParseException;
import interpreter.java.parsii.tokenizer.Token;
import interpreter.java.parsii.tokenizer.Tokenizer;
 ...
 * <p>
 * Takes a string input as String or Reader which will be translated into an {@link StringBasedExpression}. If one or more errors
 ...
 * StringBasedExpression expr = Parser.parse("3 + a * 4");
 * a.setValue(4);
...
public class Parser implements Serializable {
     ...
     */
    public static StringBasedExpression parse(String input) throws ParseException {
     ...
     * @throws ParseException if the expression contains one or more errors
     */
    public static StringBasedExpression parse(Reader input) throws ParseException {
     ...
     * @throws ParseException if the expression contains one or more errors
     */
    public static StringBasedExpression parse(String input, Scope scope) throws ParseException {
     ...
     * @throws ParseException if the expression contains one or more errors
     */
    public static StringBasedExpression parse(Reader input, Scope scope) throws ParseException {
     ...
     * @throws ParseException if the expression contains one or more errors
     */
    protected StringBasedExpression parse() throws ParseException {
        StringBasedExpression result = expression().simplify();
     ...
     */
    protected StringBasedExpression expression() {
        StringBasedExpression left = relationalExpression();
        if (tokenizer.current().isSymbol("&&")) {
            tokenizer.consume();
            StringBasedExpression right = expression();
     ...
     */
    protected StringBasedExpression relationalExpression() {
        StringBasedExpression left = term();
        if (tokenizer.current().isSymbol("<")) {
            tokenizer.consume();
            StringBasedExpression right = relationalExpression();
     ...
     */
    protected StringBasedExpression term() {
        StringBasedExpression left = product();
        if (tokenizer.current().isSymbol("+")) {
            tokenizer.consume();
            StringBasedExpression right = term();
     ...
     */
    protected StringBasedExpression product() {
        StringBasedExpression left = power();
        if (tokenizer.current().isSymbol("*")) {
            tokenizer.consume();
            StringBasedExpression right = product();
     ...
     */
    protected StringBasedExpression reOrder(StringBasedExpression left, StringBasedExpression right, BinaryOperation.Op op) {
    ...
    protected void replaceLeft(BinaryOperation target, StringBasedExpression newLeft, BinaryOperation.Op op) {
     ...
     */
    protected StringBasedExpression power() {
        StringBasedExpression left = atom();
        if (tokenizer.current().isSymbol("^") || tokenizer.current().isSymbol("**")) {
            tokenizer.consume();
            StringBasedExpression right = power();
     ...
     */
    protected StringBasedExpression atom() {
        if (tokenizer.current().isSymbol("-")) {
            tokenizer.consume();
        ...
        if (tokenizer.current().isSymbol("(")) {
            tokenizer.consume();
            StringBasedExpression result = expression();
     ...
     * @return an atom parsed from the given input
     */
    private StringBasedExpression literalAtom() {
     ...
     *
     * @return the function call as StringBasedExpression
     */
    protected StringBasedExpression functionCall() {
        FunctionCall call = new FunctionCall();
