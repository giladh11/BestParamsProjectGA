...
public class TalTest {
    ...
    public static void main(String[] args) {
        ...
        ParamGA paramGA = new ParamGA(populationSize, pParentSurviveRate, pCrossover, pMutation, dataSetSize, maxInitialTreeDepth, bloatPenaltyRate);//(int populationSize, int pParentSurviveRate, double pMutation, double pCrossover, int dataSetSize, int maxInitialTreeDepth, int bloatPenaltyRate)
